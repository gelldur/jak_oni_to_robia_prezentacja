...
# instance fields
.field private final ˊ:Lcom/squareup/okhttp/OkHttpClient;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 45
    invoke-static {p1}, Lo/WR;->ˋ(Landroid/content/Context;)Ljava/io/File;

    move-result-object v0

    invoke-direct {p0, v0}, Lo/Ww;-><init>(Ljava/io/File;)V
...
.method public constructor <init>(Landroid/content/Context;J)V
    ...
    invoke-direct {p0, v0, p2, p3}, Lo/Ww;-><init>(Ljava/io/File;J)V
...
.method public constructor <init>(Lcom/squareup/okhttp/OkHttpClient;)V
    ...
    .line 88
    iput-object p1, p0, Lo/Ww;->ˊ:Lcom/squareup/okhttp/OkHttpClient;
...
.method public constructor <init>(Ljava/io/File;)V
    ...
    .line 55
    invoke-static {p1}, Lo/WR;->ˊ(Ljava/io/File;)J

    move-result-wide v0

    invoke-direct {p0, p1, v0, v1}, Lo/Ww;-><init>(Ljava/io/File;J)V
...
.method public constructor <init>(Ljava/io/File;J)V
    ...
    .line 76
    invoke-static {}, Lo/Ww;->ˎ()Lcom/squareup/okhttp/OkHttpClient;

    move-result-object v0

    invoke-direct {p0, v0}, Lo/Ww;-><init>(Lcom/squareup/okhttp/OkHttpClient;)V

    .line 78
    :try_start_0
    iget-object v0, p0, Lo/Ww;->ˊ:Lcom/squareup/okhttp/OkHttpClient;
...
.method private static ˎ()Lcom/squareup/okhttp/OkHttpClient;
    .locals 4
...
.method public ˊ(Landroid/net/Uri;I)Lo/Wl$if;
    ...
    invoke-direct {v0, v1, p2, v7}, Lo/Wl$ˊ;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v1, v8, v2, v3}, Lo/Wl$if;-><init>(Ljava/io/InputStream;ZJ)V
...
.method protected final ˋ()Lcom/squareup/okhttp/OkHttpClient;
    .locals 1
